    ...
    <section>
      <div className="relative mx-auto max-w-[1180px] px-4 sm:px-6 mb-12 ">
        <div className="pb-12 md:pb-20 ">
          ...
          {/* Spotlight items */}
          <Spotlight className=" realtive mx-auto mt-5 grid max-w-sm items-start gap-6 lg:max-w-none lg:grid-cols-3 ">
            {/* Card 1 */}
            <a
              className="group relative border-black/10 shadow-md transition-shadow hover:shadow-lg h-full overflow-hidden rounded-2xl bg-slate-50 p-px before:pointer-events-none before:absolute before:-left-40 before:-top-40 before:z-10 before:h-80 before:w-80 before:translate-x-[var(--mouse-x)] before:translate-y-[var(--mouse-y)] before:rounded-full before:bg-orange-900/80 before:opacity-0 before:blur-3xl before:transition-opacity before:duration-500 after:pointer-events-none after:absolute after:-left-48 after:-top-48 after:z-10 after:h-64 after:w-64 after:translate-x-[var(--mouse-x)] after:translate-y-[var(--mouse-y)] after:rounded-full after:bg-orange-500 after:opacity-0 after:blur-3xl after:transition-opacity after:duration-500 after:hover:opacity-20 before:group-hover:opacity-100"
            ...
            >
              <div className="relative z-10 h-full overflow-hidden rounded-[inherit] bg-neutral-50 shadow-lg after:absolute after:inset-0 after:-z-10 after:bg-gradient-to-br after:from-gray-200/50 after:via-gray-100/25 after:to-gray-200/50">
                {/* Arrow */}
                <div
                  className="absolute right-6 top-6 flex h-8 w-8 items-center justify-center rounded-full border border-gray-700/50 bg-orange-900 text-theme-primary opacity-0 transition-opacity duration-300 group-hover:opacity-95 z-20"
                  aria-hidden="true"
                >
                  <svg
                ...
                <div className="p-6 z-20">
                  <div className="mb-3">
                    <div className="btn-sm gap-1 leading-tight p-16 text-center bg-gradient-to-l from-indigo-900 to-purple-950 bg-clip-text text-transparent relative rounded-full  px-5 py-1.5 text-md font-semibold before:pointer-events-none before:absolute before:inset-0 before:rounded-[inherit] before:border before:border-transparent before:[background:linear-gradient(to_bottom,theme(colors.blue.700/.15),theme(colors.blue.700/.5))_border-box] before:[mask-composite:exclude_!important] before:[mask:linear-gradient(white_0_0)_padding-box,_linear-gradient(white_0_0)] ">
                      Unit Testing
