...
export default function FeaturesPlanet() {
  return (
    <section className="relative before:absolute before:inset-0 before:-z-20 before:bg-slate-950">
      ...
      <div
        ...
        <div className="py-12 md:py-20">
          ...
          <div className="mx-auto max-w-3xl pb-16 text-center md:pb-20">
            ...
            Why Keploy for API Test Automation
            </h2>
          </div>
          {/* Grid */}
          <div className="grid overflow-hidden sm:grid-cols-2 lg:grid-cols-3 [&>*]:relative [&>*]:p-6 [&>*]:before:absolute [&>*]:before:bg-gray-800 [&>*]:before:[block-size:100vh] [&>*]:before:[inline-size:1px] [&>*]:before:[inset-block-start:0] [&>*]:before:[inset-inline-start:-1px] [&>*]:after:absolute [&>*]:after:bg-gray-800 [&>*]:after:[block-size:1px] [&>*]:after:[inline-size:100vw] [&>*]:after:[inset-block-start:-1px] [&>*]:after:[inset-inline-start:0] md:[&>*]:p-10">
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
                ...
                <span>Effortless Testing</span>
              </h3>
              <p className="text-[15px] text-gray-400">
              Keploy can ease API testing processes, allowing developers to conduct tests effortlessly without the need for complex setups.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
                ...
                <span>Dynamic Mocks</span>
              </h3>
              <p className="text-[15px] text-gray-400">
                Get dynamic mock data, making your tests more realistic, 
                for testing your API without relying on external services or dependencies.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
                ...
                <span>Automated Test Creation</span>
              </h3>
              <p className="text-[15px] text-gray-400">
            ...
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
                ...
                <span>No Flaky Tests</span>
              </h3>
              <p className="text-[15px] text-gray-400">
                By recording and replaying deterministic API responses,
                Keploy ensures test consistency across environments.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
                ...
                <span>Real-World Traffic Replay</span>
              </h3>
              <p className="text-[15px] text-gray-400">
              Keploy uses captured real-world API traffic 
              to validate behavior, ensuring that tests reflect 
              real usage and edge cases that might otherwise be missed.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
              ...
              <p className="text-[15px] text-gray-400">
              Keploy empowers teams to work confidently by through automated 
              testing, reducing the feedback loop, and accelerating the release cycle.
              </p>
            </article>
          </div>
          <div className="relative before:absolute before:inset-0">
                ...
                >
                  <a
                    className="btn group mb-4 w-full bg-gradient-to-t from-slate-500 to-gray-500 text-white sm:mb-0 sm:w-auto"
