        ...
        <header className="flex h-[4.5rem] items-center justify-between">
          ...
          <div className="flex items-center justify-end space-x-2">
            ...
            <Button
              variant="default"
              asChild
              className="hidden md:flex text-white px-6 py-2 bg-gradient-to-r from-orange-500 to-red-500 hover:from-red-500 hover:to-orange-500 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 ease-in-out items-center justify-center relative overflow-hidden "
