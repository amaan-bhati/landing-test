        ...
        <div className="max-w-xl mx-auto md:max-w-none pt-48 pb-24 flex flex-col md:flex-row md:space-x-8 lg:space-x-16 xl:space-x-20 space-y-8 space-y-reverse md:space-y-0">
          ...
          >
            ...
            <h3 className="h3 bg-clip-text text-transparent bg-gradient-to-r from-orange-300/80 via-slate-200 to-slate-300/80 pb-6 md:pb-8">
              Instant Unit Tests for Your GitHub PRs!
            </h3>
            ...
            <div className="mt-10 max-md:text-center">
              <button
                  ...
                  onClick={() => {
                    window.location.href = window.innerWidth < 1024 ? "https://marketplace.visualstudio.com/items?itemName=Keploy.keployio" : "vscode:extension/Keploy.keployio";
                  }}
              >
                Install Now
              </button>
                ...
                <div className="relative flex w-48 h-48 justify-center items-center">
                  ...
                  >
                    <div className="absolute z-30">
                      <div className="relative flex items-center justify-center w-auto h-auto border border-transparent  -rotate-[1deg] before:absolute before:inset-0 ">
                        <div>
                          <Image
                            className=" mt-0 md:mb-0 max-w-sm sm:mx-auto md:max-w-lg lg:max-w-none md:mt-60 "
                            src={VSCode}
                            width={870}
                            height={920}
                            alt="Unit testing agent - Github app"
                          />
                        </div>
                        {/*<svg*/}
                  ...
                  >
                    <div className="absolute z-30">
                      <div className="relative flex items-center justify-center w-auto h-auto border border-transparent -rotate-[10deg]  before:absolute before:inset-0 ">
                        <div>
                          <Image
                              className="mt-0 md:mb-0 max-w-sm sm:max-w-lg md:max-w-lg lg:max-w-none md:mt-60 "
                              src={UnitTesting}
                              width={850}
                              height={920}
                              alt="Carousel 02"
                  ...
                  >
                    <div className="absolute z-30">
                      <div className="relative flex items-center justify-center md:justify-end w-48 h-48 border border-transparent -rotate-[1deg]">
                        <div>
                          <Image
                            className="mt-0 md:mb-0 max-w-sm sm:max-w-lg md:max-w-sm lg:max-w-none md:mt-60 md:-mr-20"
                            src={Dashboard}
                            width={750}
                            height={980}
                            alt="Keploy Enterprise Dashboard"
                          />
                        </div>
                        {/*<svg*/}
                        {/*    className="relative fill-slate-200"*/}
