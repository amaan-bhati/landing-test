            ...
            <div className="relative lg:max-w-none">
              <div className="relative flex flex-col" ref={tabs}>
                ...
                >
                  <div>
                    <Image
                      className=" z-30 mt-5 max-w-sm sm:max-w-lg md:max-w-lg lg:max-w-none rounded-lg shadow-2xl md:mt-52 "
                      src={UnitTesting}
                      width={700}
                      height={720}
                      alt="Carousel 01"
                ...
                >
                  <div>
                    <Image
                      className="z-30 lg:max-w-none mx-auto rounded-lg shadow-2xl lg:pt-20 lg:-rotate-[1deg] "
                      src={WorflowImg01}
                      width={700}
                      height={620}
                      alt="Carousel 02"
                ...
                >
                  <div>
                    <Image
                      className="  max-w-lg md:max-w-3xl lg:max-w-none  "
